...
{
   filename = "data/pkg/sound/weapons/GRENADELAND.wav";
...
{
   filename = "data/pkg/sound/weapons/Crossbow_explosion";
   description = AudioDefault3d;
   preload = true;
};
...
{
   textureName = "data/pkg/art/particles/impact";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.494118;
   times[2] = 1.0;
   animTexName = "data/pkg/art/particles/impact";
...
{
   shapeFile = "data/pkg/art/shapes/weapons/Grenade/grenadeDebris.dae";
...
datablock ParticleData(GrenadeSplashMist)
{
   ...
   textureName = "data/pkg/art/particles/smoke";
...
datablock ParticleData(GrenadeSplashParticle)
{
   ...
   textureName = "data/pkg/art/particles/droplet";
...
{
   textureName = "data/pkg/art/particles/wake";
...
datablock SplashData(GrenadeSplash)
{
   ...
   emitter[2] = GrenadeSplashRingEmitter;
    ...
    //acceleration = -3.0;
    //texWrap = 5.0;
    //texture = "data/pkg/art/images/particles//splash";
...
{
   textureName = "data/pkg/art/particles/fireball.png";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.25;
   times[2] = 0.5;
   animTexName = "data/pkg/art/particles/fireball.png";
   times[3] = "1";
...
{
   textureName = "data/pkg/art/particles/smoke.png";
   ...
   times[1] = 0.494118;
   times[2] = 1.0;
   animTexName = "data/pkg/art/particles/smoke.png";
...
{
   textureName = "data/pkg/art/particles/Sparkparticle";
   dragCoeffiecient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
datablock ParticleData(GrenadeExpSmoke)
{
   ...
   times[1] = 0.498039;
   times[2] = 1;
   animTexName = "data/pkg/art/particles/smoke";
   times[3] = "1";
};
...
{
   textureName = "data/pkg/art/particles/steam";
   dragCoeffiecient = 1.0;
...
{
   textureName = "data/pkg/art/particles/spark_wet";
   dragCoeffiecient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
{
   textureName = "data/pkg/art/particles/millsplash01";
   dragCoeffiecient = 0.0;
...
{
   textureName = "data/pkg/art/particles/bubble";
   dragCoeffiecient = 0.0;
...
{
   projectileShapeName = "data/pkg/art/shapes/weapons/shared/rocket.dts";
   directDamage = 30;
   radiusDamage = 30;
   damageRadius = 5;
   areaImpulse = 2000;
